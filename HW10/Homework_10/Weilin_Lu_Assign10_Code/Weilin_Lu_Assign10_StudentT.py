...
def Student_t(degree):
    for d in degree:
        ...
        value11 = stats.t.pdf(Xy2_ave, d, location11, scale11)
        value11 = value11.tolist()

        value12 = stats.t.pdf(Xy2_std, d, location12, scale12)
        value12 = value12.tolist()

        value01 = stats.t.pdf(Xy2_ave, d, location01, scale01)
        value01 = value01.tolist()

        value02 = stats.t.pdf(Xy2_std, d, location02, scale02)
        ...
        print("Accuracy for {} is {}% ".format(d, round(accuracy*100, 2)))
        ...
        print("TPR  for Year2 is {}".format(round(tpr, 3)))
        print("TNR  for Year2 is {}".format(round(tnr,3)))
        print("####################################################")
